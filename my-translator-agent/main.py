...
st.title("👽 Kishor Kumar Translator Agent")
st.write("This is a simple translator agent that uses the Gemini API to translate text.")

user_input = st.text_area("Enter text to translate: auto detect language", height=100,)
target_language = st.selectbox("Select target language:", ["Hindi","Spanish", "French",  "German", "Chinese", "Urdu","Roman Urdu", "English","Japanese","Korean","Russian","Italian"])
